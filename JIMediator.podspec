...
Pod::Spec.new do |s|
  s.name             = 'JIMediator'
  s.version          = '0.1.0'
  s.summary          = 'A short description of JIMediator.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jerry/JIMediator'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jerry' => 'jerryelectricity@me.com' }
  s.source           = { :git => 'https://github.com/Jerry/JIMediator.git', :tag => s.version.to_s }
